...
process plinkPCA {
	...
	plink2 --vcf remapped.vcf --pca allele-wts --allow-extra-chr --bad-freqs
	get_PCA_snps.rb plink2.eigenvec.allelle chr_maps.csv ${params.maxPCASNPs} ${params.maxPCAPC} > pca_sites.txt
